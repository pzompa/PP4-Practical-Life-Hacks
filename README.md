...
5. [Testing](TESTING.md#table-of-content)
    ...
    3. [Validator Testing](TESTING.md#validator-testing)
    4. [PEP8 Testing](TESTING.md#pep8-testing)
    5. [Wavetest](TESTING.md#wavetest)
    6. [Lighthouse Testing](TESTING.md#lighthouse-testing)
    7. [Manual Testing](TESTING.md#manual-testing)
